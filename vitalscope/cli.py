"""Interface en ligne de commande.
    ...
    python -m vitalscope analyser  video.mp4 --rapport rapport.html
    python -m vitalscope demo      --duree 90
    python -m vitalscope lot       dossier/ --csv cohorte.csv
    python -m vitalscope calibrer  cohorte.csv --cible age --groupe subject_id
"""
...
def cmd_demo(args) -> int:
    ...
    tmp = args.sortie_video or "demo_vitalscope.mp4"
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="vitalscope",
